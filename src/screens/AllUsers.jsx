...
const AllUsers = ({navigation}) => {
  ...
  return (
    <SafeAreaView style={{padding:20}}>
        ...
        <ScrollView>
            {users.map((user,ind)=>
            <TouchableOpacity onPress={()=>navigation.navigate('ParticularUser',{user})} key={ind}>
                <View style={{display:'flex',flexDirection:'row',gap:30,backgroundColor:'#ccc',paddingVertical:10,paddingHorizontal:20,alignItems:'center',borderRadius:10,marginBottom:10,justifyContent:'space-between'}}>
